...
static void test_orange_orange_black(void)
{
   ...
   TEST_ASSERT_EQUAL_STRING("OHMS", actual.unit);
}
...
static void test_red_black_red(void)
{
   ...
   TEST_ASSERT_EQUAL_STRING("KILOOHMS", actual.unit);
}
...
static void test_blue_violet_blue(void)
{
   ...
   TEST_ASSERT_EQUAL_STRING("MEGAOHMS", actual.unit);
}
...
static void test_maximum_possible_value(void)
{
   ...
   TEST_ASSERT_EQUAL_STRING("GIGAOHMS",actual.unit);
}
